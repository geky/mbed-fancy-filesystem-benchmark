...
///* Color palette. */
//static const uint32_t palette[] = { 0x00FF00000 }; //{0x0000001F}; //{0x001F0000U, 0x7C0003E0U};
//
...
status_t APP_LCDC_Init(void)
{
    ...
    lcdConfig.upperPanelAddr = (uint32_t)frame;
...
//        //if (i++ % 100 == 0) {
//        while (true) {
//            frame[rand() % (IMG_WIDTH*IMG_HEIGHT)] = rand();
//    //        frame[i % (IMG_WIDTH*IMG_HEIGHT)] = (((i%IMG_WIDTH) + (i/IMG_WIDTH)%IMG_HEIGHT) / 5) + (i / (IMG_WIDTH*IMG_HEIGHT));
//    //        i++;
//        }
//        //}
